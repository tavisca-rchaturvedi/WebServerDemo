...
public class Server implements Runnable {
    ...
    public void run(){
        ...
        try {
            ...
            requestHandler = new RequestHandler(bufferedReader.readLine());
            ...
            requestAndResponseHelper.processAndRespondToClient(new ResponseHandler(), requestHandler, clientSocket);
